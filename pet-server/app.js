...
app.use('/adopt_uploads', express.static('./adopt_uploads'))
app.use('/article_uploads', express.static('./article_uploads'))
...
const GoodImageRouter = require('./router/GoodImageRouter.js')
const WebsocketRouter = require('./router/WebSocketRouter.js')
const ServiceImageRouter = require('./router/ServiceImageRouter.js')
const AdoptRouter = require('./router/AdoptRouter.js')
...
app.use(PayRouter)
app.use(GoodImageRouter)
app.use(ServiceImageRouter)
app.use(AdoptRouter)
app.use(ApplyRouter)
