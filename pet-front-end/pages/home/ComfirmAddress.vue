<template>
  <view class="container">
    <view class="address-list">
      <view class="a-address" v-for="(item, index) in addressList" :key="item.address_id">
        <view class="left-text" :class="item.isDefault ? 'active' : ''" @tap="selectTap(item)">
        ...
        <view class="right-edit" @tap="editAddress(item)"></view>
      </view>
    </view>
