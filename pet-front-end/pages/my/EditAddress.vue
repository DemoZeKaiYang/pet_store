<template>
  <view>
    <view class="editaddress">
        ...
        <uni-forms :modelValue="formData" ref="form">
          <uni-forms-item name="address_name">
            <view class="row">
              ...
              <view class="input"><input placeholder="请输入收货人姓名" v-model="formData.address_name" type="text" />
              </view>
            </view>
          </uni-forms-item>
          <uni-forms-item name="address_phone">
            <view class="row">
              ...
              <view class="input"><input placeholder="请输入收货人电话号码" v-model="formData.address_phone" type="number"
                  maxlength="11" /></view>
            </view>
          </uni-forms-item>
          <uni-forms-item name="address_area">
            <view class="row">
              ...
              <view class="input selectcity" @tap="openPicker">
                ...
                <input placeholder="请选择省市区" readonly type="text" disabled v-model="formData.address_area"
                  ref="selectArea" style="display: none;" />
          ...
          <uni-forms-item name="address_details">
            <view class="row">
              ...
              <view class="input"><textarea style="font-size: 28rpx;" v-model="formData.address_details"
            ...
            <view class="row">
              ...
              <view class="input switch">
                <switch :color="colors" style="transform:scale(0.8)" @change="switchChange"
                  :checked="formData.address_default == 1"></switch>
              </view>
            </view>
          </uni-forms-item>
        </uni-forms>
      ...
      <SelectCit :show="show" @changeClick="changeClick" @sureSelectArea="onsetCity" @hideShow="onhideShow"></SelectCit>
    </view>
...
<script setup>
  ...
  const onsetCity = (e) => {
    ...
    // const address = `${data.province}${data.city}${data.area}`;
    // show.value = false;
    // addressData.value.address = address;
  }
