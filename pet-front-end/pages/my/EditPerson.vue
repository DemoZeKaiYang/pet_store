    ...
    <view class="ui-all">
      <view class="avatar" @tap="avatarChoose">
        <view class="imgAvatar">
          <view class="iavatar" :style="'background: url('+store.avatar+') no-repeat center/cover #eeeeee;'">
          </view>
        </view>
        <text>修改头像</text>
      </view>
      <view class="ui-list">
        <text>昵称</text>
        <input type="text" placeholder="请填写用户名4到16位(字母，数字，下划线)" v-model="store.user.user_name"
      ...
      <view class="ui-list">
        <text>签名</text>
        <textarea placeholder="请填写" placeholder-class="place" v-model="store.user.user_signature"></textarea>
      </view>
